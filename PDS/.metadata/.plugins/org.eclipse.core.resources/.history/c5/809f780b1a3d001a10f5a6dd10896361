...
<body class="" id="top">
	...
	<div class="content">
		<div class="form">
			<form class="login-form" action="/pdsWEB/auth/registracija"
				method="POST">
				<table>
					<tr>
						<th>${poruka}</th>
					...
					<tr>
						<td><input type="date" name="datumRodjenja"
							placeholder="Unesite datum rodjenja" required></td>
					</tr>
					<tr>
						<td><input type="hidden" name="${_csrf.parameterName}"
							value="${_csrf.token}" /></td>
						<td><input class="button" type="submit" value="Registruj se"></td>
					</tr>
				</table>
			</form>
		</div>
