					...
					<nav class="horizontal-nav full-width horizontalNav-notprocessed">
						<ul class="sf-menu">
							...
							<li><a href="/pdsWEB/Izvestaj/listaI">Li&#269na
									Iskustva!</a></li>
							<li  class="current"><a href="/pdsWEB/PlaninarskiDom/listaPD">Sme&#353taj</a></li>
			...
			<div class="gallery">
				<c:forEach items="${planinarskidomovi}" var="pd">
					<div class="grid_3">
						...
						<a href="planine/planinarskiDom.jsp" class="gal"><img
							src="images/${pd.naziv}/1.png" alt="${pd.naziv}"></a>
						${pd.opis} <br> <a
