...
<body class="" id="top">
	...
	<div class="content">
		<div class="form">
			<form class="login-form" action="/pdsWEB/Rezervacija/dodaj"
				method="POST">
				<table>
					<tr>
						<th>${poruka}</th>
					...
					<tr>
						<td>Rezervacija za ${vrsta} ${pd.naziv}.</td>
					</tr>
					<tr>
						<td><input type="date" name="datum"
							placeholder="Unesite datum dolaska" min="${ds}" required></td>
					</tr>
					<tr>
						<td><input type="hidden" name="${_csrf.parameterName}"
							value="${_csrf.token}" /></td>
						<td><input class="button" type="submit" value="Rezervisi"></td>
					</tr>
				</table>
			</form>
		</div>
